...
const Navbar = () => {
  ...
  return (
    <>
      <header
        className={`z-10 md:px-32 px-10 ease-in-out duration-500 sticky top-0 shadow-xl bg-white ${
          ...
          <div>
            <Link href="/">
              <img
                className={`  ${
                  animateHeader && "h-4"
                } ease-in-out duration-500 h-10 md:block hidden `}
                src="/logo.svg"
                alt=""
              />
              <img
                className={` ease-in-out duration-500 h-10 md:hidden `}
                src="https://www.pngfind.com/pngs/m/350-3504187_uva-gross-university-of-amsterdam-logo-hd-png.png"
                alt=""
              />
            </Link>
          </div>
          <div className="flex gap-6 items-center">
            ...
            <div className=" flex gap-4">
              ...
              <div className="" onClick={() => setShowmenu(!showmenu)}>
                {showmenu ? (
                  <img className=" h-10 md:hidden" src="/close.svg" alt="" />
                ) : (
                  <img className=" h-10 md:hidden" src="/menu.svg" alt="" />
                )}
              </div>
            </div>
          </div>
